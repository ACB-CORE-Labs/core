...
- **`docs/adr/README.md`** — ADRs 0012–0014 and `SESSION-2026-05-13` were already listed in the index (scaffolded in a prior session). The actual files did not yet exist. Created in this session.
