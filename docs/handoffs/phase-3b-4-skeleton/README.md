...
| `en_core_names_v1/gender.jsonl` | `packs/data/en_core_names_v1/gender.jsonl` | Gendered-name pack data |
| `en_core_names_v1/manifest.json` | `packs/data/en_core_names_v1/manifest.json` | Pack manifest (checksum verified) |
...
4. Move the pack into `packs/data/`
