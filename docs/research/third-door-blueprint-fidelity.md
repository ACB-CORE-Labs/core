...
| W1 | WaveManifold unitary / sandwich step | ADR-0241 §2 | 🟢 substrate landed (`wave_manifold.py`) | ADR-0241 |
...
- Chiral charge: conserved under unitary \(R\); even unit versor honest at ~0.
