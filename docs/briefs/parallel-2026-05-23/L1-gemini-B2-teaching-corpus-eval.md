...
1. `docs/adr/ADR-0131-math-expert-rebench.md` — the composite-gate framing.
...
- `docs/adr/ADR-0131.2-teaching-corpus-eval.md` — short ADR; cite ADR-0131 parent and ADR-0064 (cross-pack teaching) as precedent.
