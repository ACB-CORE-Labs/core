...
| L7 — Teaching loop | ✅ Audited | **PARTIAL** | None — flagged recognition-refusal / explain() wiring as debt | 2026-05-24 |
...
The scope's layering table cited Layer L7 concerns as: correction extraction, review, proposal log, replay-equivalence, teaching corpus, pointing to [teaching/correction.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/correction.py), [teaching/review.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/review.py), [teaching/store.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/store.py), [teaching/replay.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/replay.py). Reality: L7 also encompasses the full offline/curriculum promotion pipeline, discovery candidate sinks, gap detection, OOV queue compilation, supersession history, and relational triple parsing.
...
|---|---|---|---|---|
| [teaching/__init__.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/__init__.py) | 33 | 0 | 2 | Live (Re-export shim) |
| [teaching/audit.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/audit.py) | 313 | 2 (`core/cli.py`, `teaching/supersede.py`) | 1 | Live |
| [teaching/contemplation.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/contemplation.py) | 505 | 1 (`core/cli.py` / `core/contemplation/__main__.py`) | 1 | Live |
| [teaching/correction.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/correction.py) | 64 | 4 (`core/cognition/pipeline.py`, `core/cognition/result.py`, `formation/promote.py`, `chat/pack_grounding.py`) | 3 | Live |
| [teaching/cross_pack_supersede.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/cross_pack_supersede.py) | 206 | 1 (`core/cli.py`) | 1 | Live |
| [teaching/discovery.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/discovery.py) | 326 | 2 (`teaching/proposals.py`, `core/cli.py`) | 2 | Live |
| [teaching/discovery_sink.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/discovery_sink.py) | 105 | 1 (`core/contemplation/__main__.py`) | 3 | Live |
| [teaching/epistemic.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/epistemic.py) | 56 | 6 (`core/cognition/pipeline.py`, `generate/proposition.py`, `vault/store.py`, `session/context.py`, `language_packs/compiler.py`, `formation/promote.py`) | 6 | Live |
| [teaching/from_curriculum.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/from_curriculum.py) | 275 | 0 | 1 | Partially live (test-only logic) |
| [teaching/from_miner.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/from_miner.py) | 370 | 0 | 1 | Partially live (test-only logic) |
| [teaching/gaps.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/gaps.py) | 206 | 1 (`core/cli.py`) | 1 | Live |
| [teaching/metric_set.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/metric_set.py) | 14 | 1 (`teaching/replay.py`) | 0 | Live |
| [teaching/migrate_proposals_source_field.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/migrate_proposals_source_field.py) | 123 | 0 | 0 | Live (One-shot migration CLI) |
| [teaching/oov_gaps.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/oov_gaps.py) | 170 | 1 (`core/cli.py`) | 1 | Live |
| [teaching/oov_promotion.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/oov_promotion.py) | 119 | 1 (`core/cli.py`) | 1 | Live |
| [teaching/oov_sink.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/oov_sink.py) | 160 | 1 (`chat/runtime.py`) | 1 | Live |
| [teaching/promotion.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/promotion.py) | 132 | 1 (`core/cli.py`) | 1 | Live |
| [teaching/proposals.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py) | 565 | 1 (`core/cli.py`) | 2 | Live |
| [teaching/provenance.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/provenance.py) | 88 | 3 (`teaching/proposals.py`, `teaching/audit.py`, `teaching/supersede.py`) | 1 | Live |
| [teaching/relation_parse.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/relation_parse.py) | 128 | 3 (`teaching/store.py`, `formation/forge.py`, `formation/smelter.py`) | 2 | Live |
| [teaching/replay.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/replay.py) | 173 | 1 (`teaching/proposals.py`) | 1 | Live |
| [teaching/review.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/review.py) | 307 | 2 (`core/cognition/pipeline.py`, `formation/promote.py`) | 3 | Live |
| [teaching/source.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/source.py) | 137 | 1 (`teaching/proposals.py`) | 1 | Live |
| [teaching/store.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/store.py) | 301 | 1 (`core/cognition/pipeline.py`) | 2 | Live |
| [teaching/supersede.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/supersede.py) | 196 | 1 (`core/cli.py`) | 1 | Live |

### Caller-trace evidence

The live turn-by-turn chat runtime captures corrections:
`ChatRuntime.chat()` → `CognitiveTurnPipeline.run()` → [_run_teaching](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/core/cognition/pipeline.py#L546) → [extract_correction](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/correction.py#L45) → [review_correction](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/review.py#L274) → [TeachingStore.add](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/store.py#L157). This builds a memory-resident [PackMutationProposal](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/store.py#L80) with `SPECULATIVE` or `CONTESTED` status on the fly.

The offline / curriculum loop writes and processes proposals:
`TurnEvent` / `CognitiveTurnResult` → [extract_discovery_candidates](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/discovery.py#L225) → written to disk via [DiscoveryMonthlyFileSink](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/discovery_sink.py#L52).
`core teaching propose` (CLI command) → [propose_from_candidate](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py#L446) → runs [run_replay_equivalence](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/replay.py#L125) → appends to `proposals.jsonl` on disk.
`core teaching review <proposal_id> --accept` (CLI command) → [accept_proposal](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py#L482) → [append_chain_to_corpus](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py#L392) → appends the chain with operator provenance to `teaching/cognition_chains/cognition_chains_v1.jsonl`.
...
1. **Replay-equivalence gate liveness.** Verified. The replay-equivalence gate ([run_replay_equivalence](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/replay.py#L125)) is called in the operator-driven CLI flow (`core teaching propose` which calls [propose_from_candidate](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py#L446)), and accepted proposals are verified in [accept_proposal](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py#L482). It is not run during live turn execution because running the full cognition split twice is slow. This matches the design of ADR-0057.
2. **Append-only proposal log.** Verified. `teaching/proposals.py:`[ProposalLog](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/teaching/proposals.py#L255) writes using `"a"` mode and never rewrites or truncates `proposals.jsonl`. Replaying the log from the top reconstructs the review-state view. The active corpus `cognition_chains_v1.jsonl` is also written using append-only `"a"` mode, with old entries retired using the `superseded_by` tag at load time.
...
4. **Teaching corpus content invariant.** Verified. [chat/teaching_grounding.py](file:///Users/kaizenpro/.gemini/antigravity/worktrees/core/audit-substrate-l7-teaching/chat/teaching_grounding.py) loads single-pack and cross-pack teaching chains and filters them against their respective declared packs. Any chain referencing missing lemmas is silently dropped.
