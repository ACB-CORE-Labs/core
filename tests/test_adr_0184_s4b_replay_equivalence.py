...
class TestCorpusEquivalence:
    ...
    def test_corpus_is_the_differential_corpus(self) -> None:
        # Corpus is every unique problem under evals/gsm8k_math/**/cases.jsonl.
        # Count moves only with a conscious re-pin of expected_traces + manifest
        # (scripts/verify_semantic_equivalence.py --update). Current pin: 1087.
